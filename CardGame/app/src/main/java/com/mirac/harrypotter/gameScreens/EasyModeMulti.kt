...
import kotlinx.android.synthetic.main.activity_easy_mode_multi.*
import java.util.*
import kotlin.collections.ArrayList

class EasyModeMulti : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_easy_mode_multi)
        object : CountDownTimer(totalTime.toLong(),1000){
            override fun onTick(millisUntilFinished: Long) {
                ...
                textViewPerson.text = "User${playPerson}"
            }
        ...
        buttons.forEachIndexed { index, button ->
            button.setOnClickListener {
                ...
                // sonuc ekranına bilgilerin gönderilmesi
                if(isAllMatch){
                    var intent = Intent(applicationContext, GameOverActivity::class.java)
                    ifAllMatch2 = true
                    intent.putExtra("point1",point1)
