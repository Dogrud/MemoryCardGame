...
import kotlinx.android.synthetic.main.activity_medium_mode_single.*


class MediumModeSingle : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_medium_mode_single)
