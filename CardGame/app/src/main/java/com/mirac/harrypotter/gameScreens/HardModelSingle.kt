...
import kotlinx.android.synthetic.main.activity_hard_model_single.*
import java.util.*
import kotlin.collections.ArrayList

class HardModelSingle : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_hard_model_single)
